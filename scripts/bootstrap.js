...
const organizationsName = 'web-steps'
const author = 'imsunhao'
...
files.forEach(shortName => {
  ...
  if (args.force || !pkgExists) {
    const json = {
      ...
      repository: {
        type: 'git',
        url: 'git+https://github.com/imsunhao/utils.git'
      },
      keywords: [],
      author,
      license: 'MIT',
      bugs: {
        url: 'https://github.com/imsunhao/utils/issues'
      },
      homepage: `https://github.com/imsunhao/utils/tree/dev/packages/${shortName}#readme`
    }
